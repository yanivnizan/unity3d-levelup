...
namespace Soomla.Levelup {
	...
	public class World : SoomlaEntity<World> {
		...
		/// <summary>
		/// Creates a <c>Level</c> with the given information and adds it to this <c>World</c>.
		/// </summary>
		/// <param name="id">Identifier.</param>
		/// <param name="target">Target.</param>
		/// <param name="targetGate">Target gate.</param>
		/// <param name="scoreTemplates">Score templates.</param>
		/// <param name="missionTemplates">Mission templates.</param>
