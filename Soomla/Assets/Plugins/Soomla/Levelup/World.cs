...
namespace Soomla.Levelup {
	...
	public class World {
		...
		public World(String worldId, Score score)
		...
		public World(String worldId, int numLevels, Score score)
			: this(worldId, null)
		{
		...
		public void AddInnerWorld(World world) {
			InnerWorlds.Add(world.WorldId, world);
		}
		...
		public void SingleScore(Score score) {
			...
			oneScore.ScoreId = oneScore.ScoreId + "_" + WorldId;
			_singleScoreId = oneScore.ScoreId;
